...
function createCard(image, number, rank, name, description) {
	...
	values1.className = "values";
	const values1Text = document.createElement("p");
	values1Text.textContent = number;
	values1.appendChild(values1Text);
	...
	values2.className = "values";
	const values2Text = document.createElement("p");
	values2Text.textContent = rank;
	values2.appendChild(values2Text);

	cardTitle.appendChild(values1);
	cardTitle.appendChild(title);
	cardTitle.appendChild(values2);

	const illustrationBox = document.createElement("section");
	...
	illustrationBox.appendChild(img);
